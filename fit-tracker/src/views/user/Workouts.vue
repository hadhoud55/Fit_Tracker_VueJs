<template>
  <div class="container mx-auto px-4 py-8">
    ...
    <div class="mb-4">
      <input v-model="search" type="text" placeholder="Search workouts..." class="w-full p-2 border rounded" @input="fetchWorkouts" />
    </div>
...
export default {
  ...
  methods: {
    async fetchWorkouts(page = this.currentPage) {
      try {
        const response = await WorkoutService.searchWorkouts(this.search, page, 9);
